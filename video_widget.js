const videos = [
	{
			...
			"product": {
					...
					"review": "The coffee is incredibly smooth. I can't say enough about how great it tastes. I'm not sure what other benefits I am getting but my taste buds have the final say when it comes to coffee and they say, `winner`.",
					"faq": {
							"answer": "Keto is a high-fat, low-carb diet. This forces your body to burn fat as its primary fuel source, leading to increased energy levels.",
			...
			similar_products: [
					...
					},
					{
							...
							"summary": "Each bag contains 12oz of gourmet ground coffee, appropriate for any drip coffee brewers, electric coffee pots, French press, or even cold brew. Each bag is sealed to preserve flavor and product integrity.",
							"pros": [
